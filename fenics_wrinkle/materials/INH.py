...
from dolfin import as_tensor, Identity, grad, tr, det, assemble, dx, Constant
...
class INHMembrane(ConvexFunction):
    ...
    def conic_repr(self, u):
        ...
        self.C_bar_el = C_bar_el = as_tensor([[C11, C12],
                                              [C12, C22]])
        # F_ = as_tensor([F0[0,0], F0[0,1],
        #                 [F0[1,0], F0[1,1]])
        # self.C_elastic = C_el = F_.T*as_tensor([[C11, C12],
        #                                                 [C12, C22]])*F_
        
        # self.C_n_el = C_n_el = self.mem.C_0*as_tensor([[C11, C12],
        #                                                 [C12, C22]])
    ...
    #     C_bar = self.mem.C_0_sup*self.C_n_el
    #     mem = self.mem
